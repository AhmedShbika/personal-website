...
<p className="text">Meet Ahmed, am Business student who has conquered JavaScript, HTML, CSS, and React. Their journey led to an impressive portfolio website, showcasing not just skills but a passion for seamless user experiences.</p>
